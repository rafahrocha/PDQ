<#
	...
	===========================================================================
	.DESCRIPTION
		Script para instalação do SQL Management Studio 2017.
    .UPDATES
        00/00/2020 - #################
#>
...
$inicio = Get-Date
$produto = 'SQL_Management_Studio_2017'
$pacote = 'Instalação'
...
$IniFile = "$caminho_scripts\SQL_Management_Studio_2017 - Install.ini"
...
if ($STATUS -ne 'Falha')
{
    ...
    Try {
        ...
        if (!($ServiceDesk._GETPROGRAM('Microsoft SQL Server Management Studio'))) {
            Throw
        }
    }
    Catch {
