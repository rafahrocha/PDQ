<#
	...
	===========================================================================
	.DESCRIPTION
		Script para instalação do Atom.
    .UPDATES
        00/00/2020 - XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX.
#>
...
$IniFile = "$caminho_scripts\Atom - Install.ini"
...
if ($STATUS -ne 'Falha')
{
    ...
    Try {
        ...
        if($FileName0 -like "*.msi"){
            ...
            Start-Process -FilePath "C:\Temp\ServiceDesk\$produto\$FileName0" -ArgumentList '--silent' -Wait
        }
        Start-Sleep -Milliseconds 300
        if (!($ServiceDesk._GETPROGRAM('Atom'))) {
            Throw
        }
    }
    Catch {
